...
const PUBLIC_PATHS = ["/api/auth/login", "/api/auth/register", "/_next", "/favicon.ico", "/api/auth/verify-otp","/api/users/me","/api/roles/switch","/api/rides/request","/api/rides/offer"];
